            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-control-panel", style: { background: T.panel, border: `1px solid ${T.line}`, borderRadius: 10, flex: "0 0 300px", height: 300, display: "flex", flexDirection: "column", overflow: "hidden" }, children: [
              ...
              live.tab === "control" ? (
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-camera-control-subpanel", style: { display: "flex", flexWrap: "wrap", gap: SP[3], padding: `${SP[2]}px ${SP[3]}px`, alignItems: "stretch", flex: 1, minHeight: 0, overflow: "hidden", boxSizing: "border-box", alignContent: "stretch" }, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-control-group", style: { ...sec, minWidth: 210, display: "flex", flexDirection: "column", gap: 6 }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-action-row", style: { display: "flex", gap: 6, alignItems: "stretch" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-mode-panel", style: { flex: 1, display: "flex", flexDirection: "column", gap: 4, minWidth: 76, padding: 4, borderRadius: 6, border: `1px solid ${T.line}`, background: "rgba(255,255,255,0.025)" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-af", onClick: () => updLive("focusMode", "af"), style: { ...sqStyle(live.focusMode === "af"), width: "100%", height: 42, fontSize: 15, fontWeight: 700 }, children: "AF" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-mf", onClick: () => updLive("focusMode", "mf"), style: { ...sqStyle(live.focusMode === "mf"), width: "100%", height: 42, fontSize: 15, fontWeight: 700 }, children: "MF" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-onepush", title: "One-Push AF", style: { ...sqStyle(false), width: "100%", height: 42, fontSize: 18 }, children: "◎" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-step-panel", style: { width: 58, display: "flex", flexDirection: "column", alignItems: "stretch", justifyContent: "center", gap: 4 }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-in", disabled: live.focusMode !== "mf", style: { ...sqStyle(false), width: "100%", opacity: live.focusMode !== "mf" ? 0.4 : 1, cursor: live.focusMode !== "mf" ? "not-allowed" : "pointer" }, children: "＋" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { id: "aver-live-focus-step-label", style: { minHeight: 24, display: "flex", alignItems: "center", justifyContent: "center", borderTop: `1px solid ${T.line}`, borderBottom: `1px solid ${T.line}`, background: "rgba(255,255,255,0.05)", fontSize: 11.5, fontWeight: 600, color: T.text }, children: "Focus" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-out", disabled: live.focusMode !== "mf", style: { ...sqStyle(false), width: "100%", opacity: live.focusMode !== "mf" ? 0.4 : 1, cursor: live.focusMode !== "mf" ? "not-allowed" : "pointer" }, children: "－" })
                      ] })
                    ] }),
