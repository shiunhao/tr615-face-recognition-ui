            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-control-panel", style: { background: T.panel, border: `1px solid ${T.line}`, borderRadius: 10, flex: "0 0 300px", height: 300, display: "flex", flexDirection: "column", overflow: "hidden" }, children: [
              ...
              live.tab === "control" ? (
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-camera-control-subpanel", style: { display: "flex", flexWrap: "wrap", gap: SP[3], padding: `${SP[2]}px ${SP[3]}px`, alignItems: "stretch", flex: 1, minHeight: 0, overflow: "hidden", boxSizing: "border-box", alignContent: "stretch" }, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-control-group", style: { ...sec, display: "flex", gap: 10, alignItems: "stretch" }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-mode-panel", style: { display: "flex", flexDirection: "column", gap: 4, minWidth: 76, padding: 4, borderRadius: 6, border: `1px solid ${T.line}`, background: "rgba(255,255,255,0.025)" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-af", onClick: () => updLive("focusMode", "af"), style: { ...sqStyle(live.focusMode === "af"), width: "100%", height: "auto", minHeight: 40, flex: 1, fontSize: 15, fontWeight: 700 }, children: "AF" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-mf", onClick: () => updLive("focusMode", "mf"), style: { ...sqStyle(live.focusMode === "mf"), width: "100%", height: "auto", minHeight: 40, flex: 1, fontSize: 15, fontWeight: 700 }, children: "MF" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-onepush", title: "One-Push AF", style: { ...sqStyle(false), width: "100%", height: "auto", minHeight: 40, flex: 1, fontSize: 18 }, children: "◎" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-step-panel", style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 6, paddingInline: 2 }, children: [
