        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { flex: 1, minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: "V3 — Face Enrollment Batch Review" }),
          ...
          versionMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-version-switcher-menu", role: "listbox", "aria-label": "Prototype versions", style: { position: "absolute", top: 38, left: 0, width: "100%", boxSizing: "border-box", padding: 4, borderRadius: 6, border: `1px solid ${T.line2}`, background: T.panel2, boxShadow: "0 10px 28px rgba(0,0,0,0.46)", overflow: "hidden" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-version-option-v2", type: "button", role: "option", "aria-selected": "false", onClick: () => window.location.assign(`${"./"}v2/index.html`), onMouseEnter: (event) => {
              ...
              event.currentTarget.style.background = "transparent";
            }, style: { width: "100%", minHeight: 32, padding: "6px 9px", border: "none", borderRadius: 4, background: "transparent", color: T.dim, fontFamily: fUI, fontSize: 11.5, textAlign: "left", cursor: "pointer" }, children: "V2 — Face Enrollment Development" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-version-option-v3", type: "button", role: "option", "aria-selected": "true", onClick: () => setVersionMenuOpen(false), style: { width: "100%", minHeight: 32, padding: "6px 9px", border: "none", borderRadius: 4, background: "rgba(30,155,240,0.16)", color: "#fff", fontFamily: fUI, fontSize: 11.5, fontWeight: 600, textAlign: "left", cursor: "pointer", boxShadow: `inset 2px 0 0 ${T.blue}` }, children: "V3 — Face Enrollment Batch Review" })
          ] })
        ]
      }
    ),
