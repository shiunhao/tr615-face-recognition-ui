...
function App$1() {
  ...
  const [faceEnrollmentNoDataDialogOpen, setFaceEnrollmentNoDataDialogOpen] = reactExports.useState(false);
  const [faceLibraryFullDialogOpen, setFaceLibraryFullDialogOpen] = reactExports.useState(false);
  ...
  const confirmFaceDelete = () => {
    ...
    captureFaceCardPositions();
    setTrk((p2) => {
      const deletedFace = p2.enrolledFaces.find((face) => face.id === faceDeleteTarget.id);
      const remainingFaces = p2.enrolledFaces.filter((face) => face.id !== faceDeleteTarget.id);
      const candidateStillExists = (deletedFace == null ? void 0 : deletedFace.candidateId) ? remainingFaces.some((face) => face.candidateId === deletedFace.candidateId) : false;
      const nextBatchResult = p2.faceBatchResult ? {
        ...p2.faceBatchResult,
        enrolled: Math.max(0, (p2.faceBatchResult.enrolled ?? 0) - 1),
        addedCandidateIds: (deletedFace == null ? void 0 : deletedFace.candidateId) && !candidateStillExists ? (p2.faceBatchResult.addedCandidateIds ?? []).filter((candidateId) => candidateId !== deletedFace.candidateId) : p2.faceBatchResult.addedCandidateIds ?? []
      } : null;
      return {
        ...p2,
  ...
  const addAllEligibleFaces = () => {
    ...
    setTrk((p2) => {
      var _a2, _b;
      const existingAddedIds = new Set(((_a2 = p2.faceBatchResult) == null ? void 0 : _a2.addedCandidateIds) ?? []);
  ...
  const startFaceAdd = (candidateId) => {
    ...
    setTrk((p2) => {
      ...
      const addedCandidateIds = new Set(((_a2 = p2.faceBatchResult) == null ? void 0 : _a2.addedCandidateIds) ?? []);
      addedCandidateIds.add(candidateId);
      return {
        ...p2,
        enrolledFaces: [...p2.enrolledFaces, newFace],
        faceBatchResult: {
          ...p2.faceBatchResult ?? {},
          enrolled: (((_b = p2.faceBatchResult) == null ? void 0 : _b.enrolled) ?? 0) + 1,
  ...
  const [livePresetPage, setLivePresetPage] = reactExports.useState(0);
    ...
    if (block === "knee") {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-control-params-knee", style: { display: "flex", flexDirection: "column", flex: 1, minHeight: 0 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            title: "Knee",
            right: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 80, display: "flex" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MiniBtn, { onClick: () => setSt((s) => ({ ...s, kneeOn: false, autoKnee: false, kneePoint: 95, kneeSlope: 0 })), children: "Default" }) })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 24, alignItems: "flex-start", flex: 1, minHeight: 0, padding: "8px 0 16px", boxSizing: "border-box" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-knee-setting", style: { display: "flex", alignItems: "center", gap: 20, marginBottom: 2 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { width: 72, fontSize: 13, color: T.text, fontWeight: 500, fontFamily: fUI }, children: "Setting" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 14 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CamRadio, { id: "aver-knee-radio-setting-on", label: "On", checked: st.kneeOn, onChange: () => upd("kneeOn", true) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CamRadio, { id: "aver-knee-radio-setting-off", label: "Off", checked: !st.kneeOn, onChange: () => upd("kneeOn", false) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 1, background: T.line, margin: "2px 0 4px" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 20, marginBottom: 6, opacity: st.kneeOn ? 1 : 0.4, pointerEvents: st.kneeOn ? "auto" : "none" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { k: "kneePoint", label: "Point", hint: "", min: 75, max: 105, val: st.kneePoint, onChange: (v2) => upd("kneePoint", v2), neutral: 95, onStartDrag: startDrag, onEndDrag: endDrag, disabled: !st.kneeOn || st.autoKnee }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { k: "kneeSlope", label: "Slope", hint: "", min: -5, max: 5, val: st.kneeSlope, onChange: (v2) => upd("kneeSlope", v2), onStartDrag: startDrag, onEndDrag: endDrag, disabled: !st.kneeOn || st.autoKnee })
        ] }) })
      ] });
    }
    if (block === "black") {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-paint-look-root", style: { position: "relative", background: T.page, width: "100%", height: "100vh", fontFamily: fUI, color: T.text, display: "flex", overflow: "hidden" }, children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { flex: 1, minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: "V3 · 08/11" }),
          ...
          versionMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-version-switcher-menu", role: "listbox", "aria-label": "Prototype versions", style: { position: "absolute", top: 38, left: 0, width: "100%", boxSizing: "border-box", padding: 4, borderRadius: 6, border: `1px solid ${T.line2}`, background: T.panel2, boxShadow: "0 10px 28px rgba(0,0,0,0.46)", overflow: "hidden" }, children: [
            ...
            }, style: { width: "100%", minHeight: 32, padding: "6px 9px", border: "none", borderRadius: 4, background: "transparent", color: T.dim, fontFamily: fUI, fontSize: 11.5, textAlign: "left", cursor: "pointer" }, children: "V1 · 08/10" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-version-option-v3", type: "button", role: "option", "aria-selected": "true", onClick: () => setVersionMenuOpen(false), style: { width: "100%", minHeight: 32, padding: "6px 9px", border: "none", borderRadius: 4, background: "rgba(30,155,240,0.16)", color: "#fff", fontFamily: fUI, fontSize: 11.5, fontWeight: 600, textAlign: "left", cursor: "pointer", boxShadow: `inset 2px 0 0 ${T.blue}` }, children: "V3 · 08/11" })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-sidebar-container", style: { width: 220, background: T.side, flexShrink: 0, paddingTop: 20, display: "flex", flexDirection: "column", height: "100vh", boxSizing: "border-box", overflowY: "auto" }, children: [
      ...
      (activeMenu === "camera" || activeMenu === "live" || activeMenu === "network" || activeMenu === "tracking" || activeMenu === "ndi" || activeMenu === "system") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aver-fade", style: { margin: "8px 0 0", padding: "12px 18px 16px", borderTop: `1px solid ${T.line}`, display: "flex", flexDirection: "column", gap: 12 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-tracking-face-enrollment-toggle", style: { display: "flex", alignItems: "flex-start", gap: 0 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: 13, lineHeight: 1.25, color: T.dim, width: 78, flexShrink: 0 }, children: [
            "Face",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Enrollment"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 24 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { width: 44 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              CamRadio,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CamRadio, { id: "aver-tracking-face-enrollment-off", label: "Off", checked: !trk.faceEnrollment, onChange: () => updTrk("faceEnrollment", false) })
          ] })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-main-stage", style: { position: "relative", flex: 1, padding: "16px 24px", minWidth: 0, background: T.page, overflow: "hidden", height: "100vh", display: "flex", flexDirection: "column", boxSizing: "border-box" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aver-page-transition", style: { width: "100%", height: "100%", minHeight: 0 }, children: [
        activeMenu === "paint" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-content-wrapper", style: { display: "flex", flexDirection: "column", gap: SP[2], width: "min(calc(75vw - 40px), 100%)", marginLeft: "max(0px, calc(16.6667vw - 225.33px))", height: "100%", minHeight: 0 }, children: paintLayout === "classic" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aver-classic-layout-entrance", style: { display: "flex", flexDirection: "column", gap: 10, width: "100%", height: "100%", minHeight: 0 }, children: [
        ...
        ) }) : activeMenu === "live" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-live-view-wrapper", style: { display: "flex", flexDirection: "column", gap: SP[2], width: "min(1200px, 100%)", marginInline: "auto", height: "100%", minHeight: 0 }, children: (() => {
          ...
          const sharedPtzControl = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-shared-ptz-control", style: { ...sec, flex: "0 0 210px", minWidth: 210, padding: "10px", display: "flex", alignItems: "center", justifyContent: "space-evenly", gap: 8, alignSelf: "stretch" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 40px)", gridTemplateRows: "repeat(3, 40px)", gap: 5 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-pan-up", type: "button", "aria-label": "Tilt up", onClick: () => handlePtz("up"), style: sharedPtzButtonStyle, children: "▲" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-pan-left", type: "button", "aria-label": "Pan left", onClick: () => handlePtz("left"), style: sharedPtzButtonStyle, children: "◀" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-pan-home", type: "button", "aria-label": "Reset PTZ view", onClick: () => handlePtz("home"), style: { ...sharedPtzButtonStyle, borderRadius: "50%", fontSize: 15 }, children: "⌂" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-pan-right", type: "button", "aria-label": "Pan right", onClick: () => handlePtz("right"), style: sharedPtzButtonStyle, children: "▶" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-pan-down", type: "button", "aria-label": "Tilt down", onClick: () => handlePtz("down"), style: sharedPtzButtonStyle, children: "▼" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", {})
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 5 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-zoom-in", type: "button", "aria-label": "Zoom in", onClick: () => handlePtz("zoom_in"), style: sharedPtzButtonStyle, children: "＋" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 11.5, color: T.faint }, children: "Zoom" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-zoom-out", type: "button", "aria-label": "Zoom out", onClick: () => handlePtz("zoom_out"), style: sharedPtzButtonStyle, children: "－" })
            ] })
          ] });
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-control-panel", style: { background: T.panel, border: `1px solid ${T.line}`, borderRadius: 10, flex: "0 0 300px", height: 300, display: "flex", flexDirection: "column", overflow: "hidden" }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-control-content-row", style: { display: "flex", gap: 8, padding: 8, flex: 1, minHeight: 0, overflow: "hidden", boxSizing: "border-box" }, children: [
                sharedPtzControl,
                live.tab === "control" ? (
                  /* ===== Camera Control ===== */
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-camera-control-subpanel", style: { display: "grid", gridTemplateColumns: "210px minmax(205px, 1fr) minmax(205px, 1fr)", gap: 8, flex: 1, minWidth: 0, minHeight: 0, overflow: "hidden", boxSizing: "border-box" }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-control-group", style: { ...sec, minWidth: 0, padding: "7px 9px", display: "flex", flexDirection: "column", gap: 4, overflow: "hidden" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-action-row", style: { display: "flex", gap: 6, alignItems: "stretch" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-mode-panel", style: { flex: 1, display: "flex", flexDirection: "column", gap: 4, minWidth: 76, padding: 4, borderRadius: 6, border: `1px solid ${T.line}`, background: "rgba(255,255,255,0.025)" }, children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-af", onClick: () => updLive("focusMode", "af"), style: { ...sqStyle(live.focusMode === "af"), width: "100%", height: 34, fontSize: 14, fontWeight: 700 }, children: "AF" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-mf", onClick: () => updLive("focusMode", "mf"), style: { ...sqStyle(live.focusMode === "mf"), width: "100%", height: 34, fontSize: 14, fontWeight: 700 }, children: "MF" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-onepush", title: "One-Push AF", style: { ...sqStyle(false), width: "100%", height: 34, fontSize: 16 }, children: "◎" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-step-panel", style: { width: 58, display: "flex", flexDirection: "column", alignItems: "stretch", justifyContent: "center", gap: 4 }, children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-in", disabled: live.focusMode !== "mf", style: { ...sqStyle(false), width: "100%", height: 34, opacity: live.focusMode !== "mf" ? 0.4 : 1, cursor: live.focusMode !== "mf" ? "not-allowed" : "pointer" }, children: "＋" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { id: "aver-live-focus-step-label", style: { minHeight: 20, display: "flex", alignItems: "center", justifyContent: "center", borderTop: `1px solid ${T.line}`, borderBottom: `1px solid ${T.line}`, background: "rgba(255,255,255,0.05)", fontSize: 11, fontWeight: 600, color: T.text }, children: "Focus" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-btn-focus-out", disabled: live.focusMode !== "mf", style: { ...sqStyle(false), width: "100%", height: 34, opacity: live.focusMode !== "mf" ? 0.4 : 1, cursor: live.focusMode !== "mf" ? "not-allowed" : "pointer" }, children: "－" })
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-focus-settings", style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...secTitle, marginBottom: 4 }, children: "Focus Near Limit" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("select", { id: "aver-live-select-focus-near", value: live.focusNear, onChange: (e) => updLive("focusNear", e.target.value), style: { width: "100%", height: 26, padding: "0 7px", fontSize: 12, borderRadius: 4, border: `1px solid ${T.line2}`, background: T.panel2, color: T.text, fontFamily: fUI, cursor: "pointer" }, children: ["1cm", "11cm", "30cm", "50cm", "80cm", "1m", "1.5m", "2m", "3m", "5m", "∞"].map((v2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: v2, children: v2 }, v2)) })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...secTitle, marginBottom: 4 }, children: "AF Mode" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("select", { id: "aver-live-select-af-mode", value: live.afMode, onChange: (e) => updLive("afMode", e.target.value), style: { width: "100%", height: 26, padding: "0 7px", fontSize: 12, borderRadius: 4, border: `1px solid ${T.line2}`, background: T.panel2, color: T.text, fontFamily: fUI, cursor: "pointer" }, children: ["Continuous AF", "One-Push AF", "Manual"].map((v2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: v2, children: v2 }, v2)) })
                        ] })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...sec, minWidth: 0, padding: 7, display: "flex", flexDirection: "column", gap: 6, overflow: "hidden" }, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-zoom-speed-panel", style: { width: "100%", background: "rgba(255, 255, 255, 0.03)", border: "1px solid rgba(255, 255, 255, 0.10)", borderRadius: 8, overflow: "hidden", boxSizing: "border-box" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "7px 12px", borderBottom: "1px solid rgba(255, 255, 255, 0.08)", background: "rgba(255,255,255,0.035)", fontSize: 12.5, color: T.text, fontWeight: 600 }, children: "Zoom Speed" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-evenly", gap: 16, minHeight: 46, padding: "6px 12px" }, children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, display: "flex", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CamRadio, { id: "aver-live-radio-zoom-speed-high", label: "High", checked: live.zoomSpeed === "high", onChange: () => updLive("zoomSpeed", "high") }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, display: "flex", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CamRadio, { id: "aver-live-radio-zoom-speed-low", label: "Low", checked: live.zoomSpeed === "low", onChange: () => updLive("zoomSpeed", "low") }) })
                        ] })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...sec, minWidth: 0, padding: 7, display: "flex", flexDirection: "column", gap: 6, overflow: "hidden" }, children: [
                  ...
                  /* ===== Preset(預設位置)===== */
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-live-preset-subpanel", style: { flex: 1, minWidth: 0, minHeight: 0, overflow: "hidden", boxSizing: "border-box" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-preset-layout-row", style: { display: "flex", gap: 10, minWidth: 0, height: "100%", minHeight: 0 }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-preset-save-options", style: { flex: "0 0 210px", minWidth: 210, display: "flex", flexDirection: "column", gap: 6 }, children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-preset-load-options", style: { ...presetSection, flex: "2 1 0", minWidth: 360, display: "flex", flexDirection: "column" }, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-preset-library-body", style: { flex: 1, minHeight: 0, display: "flex", flexDirection: "column", alignItems: "stretch", gap: 6, padding: 7 }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-live-preset-save-panel", style: { flex: "0 0 auto", minWidth: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexWrap: "wrap", columnGap: 6, rowGap: 4, padding: "0 0 2px", alignItems: "center" }, children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-preset-save-reset-group", style: { display: "flex", alignItems: "center", gap: 6, minWidth: 0 }, children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: T.faint, fontSize: 11, fontWeight: 600, whiteSpace: "nowrap" }, children: "Save Preset" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "aver-live-preset-save-number", "aria-label": "Save preset number", type: "number", min: "0", max: "255", value: live.presetSaveNumber, onChange: (event) => updLive("presetSaveNumber", event.target.value), style: { ...presetInput, width: 54, height: 23, flex: "0 0 54px", fontSize: 11.5 } }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-preset-save-button", type: "button", onClick: saveLivePreset, style: { ...presetButton, height: 23, padding: "0 10px", fontSize: 11 }, children: "Save" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "button",
                              {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": "true", style: { alignSelf: "stretch", width: 1, background: T.line2, margin: "0 2px" } }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-preset-edit-scenes-button", type: "button", onClick: () => flash("Edit Scenes ready"), style: { ...presetButton, height: 23, padding: "0 9px", fontSize: 11 }, children: "Edit Scenes" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-live-preset-pagination", style: { marginLeft: "auto", display: "flex", alignItems: "center", gap: 6 }, children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-preset-page-previous", type: "button", "aria-label": "Previous preset page", disabled: livePresetPage === 0, onClick: () => setLivePresetPage((page) => Math.max(0, page - 1)), style: { ...presetButton, height: 21, minWidth: 25, padding: "0 6px", opacity: livePresetPage === 0 ? 0.42 : 1, cursor: livePresetPage === 0 ? "not-allowed" : "pointer" }, children: "‹" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { id: "aver-live-preset-page-status", style: { minWidth: 62, color: T.text, fontFamily: fMono, fontSize: 10.5, textAlign: "center" }, children: [
                              livePresetPage + 1,
                              " / ",
                              LIVE_PRESET_PAGE_COUNT
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-live-preset-page-next", type: "button", "aria-label": "Next preset page", disabled: livePresetPage === LIVE_PRESET_PAGE_COUNT - 1, onClick: () => setLivePresetPage((page) => Math.min(LIVE_PRESET_PAGE_COUNT - 1, page + 1)), style: { ...presetButton, height: 21, minWidth: 25, padding: "0 6px", opacity: livePresetPage === LIVE_PRESET_PAGE_COUNT - 1 ? 0.42 : 1, cursor: livePresetPage === LIVE_PRESET_PAGE_COUNT - 1 ? "not-allowed" : "pointer" }, children: "›" })
                          ] })
                        ] }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-live-preset-library-cards-column", style: { flex: "1 1 0", minWidth: 0, minHeight: 0, display: "flex", flexDirection: "column", gap: 5 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-live-preset-card-scroll", style: { flex: 1, minHeight: 0, overflow: "hidden" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-live-preset-quick-call-grid", style: { height: "100%", display: "grid", gridTemplateColumns: "repeat(6, minmax(0, 1fr))", gridTemplateRows: "repeat(2, minmax(0, 1fr))", gap: 6 }, children: visibleLivePresetIds.map((n2) => {
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                  "div",
                                  {
                                    ...
                                    children: [
                                      ...
                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { position: "absolute", zIndex: 1, left: 4, top: 3, minWidth: 24, height: 16, padding: "0 3px", boxSizing: "border-box", display: "inline-flex", alignItems: "center", justifyContent: "center", borderRadius: 3, background: "rgba(0,0,0,0.72)", color: "#fff", fontFamily: fMono, fontSize: 9, fontWeight: 700 }, children: String(n2).padStart(3, "0") }),
                  ...
                  trk.faceCaptureState === "complete" && FACE_ENROLLMENT_CANDIDATES.map((candidate) => {
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "g",
                      {
                        ...
                        role: isInteractiveFaceFrame ? "button" : void 0,
                        tabIndex: isInteractiveFaceFrame ? 0 : void 0,
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: x2, y: y2, width: size, height: size, fill: isHovered ? isValidSelectFace ? "rgba(23,145,236,0.13)" : "rgba(226,75,75,0.12)" : "rgba(23,145,236,0.001)", stroke: color, strokeWidth: isHovered ? "8" : "5", vectorEffect: "non-scaling-stroke" }),
                          false
                        ]
                      },
                      candidate.id
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-trk-tab-content", style: { flex: 1, minHeight: 0, overflowY: "auto", padding: 8 }, children: trk.tab === "presenter" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, alignItems: "start" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-face-enrollment", style: { height: "100%", minHeight: 0, display: "flex" }, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-enrolled-face-panel", style: { flex: "1 1 0", minWidth: 0, minHeight: 0, padding: 4, display: "flex", flexDirection: "column", gap: 8 }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-face-enrollment-header", style: { display: "flex", alignItems: "center", gap: 12 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, minWidth: 0 }, children: [
                      ...
                      trk.enrolledFaces.length >= 20 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { id: "aver-enrolled-face-library-full-status", role: "status", style: { padding: "3px 7px", borderRadius: 4, border: "1px solid rgba(245,166,35,0.42)", background: "rgba(245,166,35,0.10)", color: "#f5b74f", fontSize: 11, fontWeight: 600, whiteSpace: "nowrap" }, children: "Face library is full" })
                    ] }) }),
                          ...
                          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: `aver-enrolled-face-slot-${order}`, style: slotStyle, children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "div",
                              {
                                ...
                                style: { position: "relative", zIndex: 1, width: 92, minWidth: 92, height: 113, display: "flex", flexDirection: "column", padding: 0, margin: 0, overflow: "hidden", boxSizing: "border-box", border: `1px solid ${isEditing ? T.blue : T.line2}`, borderRadius: 6, background: isEditing ? "rgba(30,155,240,0.10)" : isDragging2 ? "rgba(30,155,240,0.05)" : T.panel, outline: isDragging2 ? "1px dashed rgba(30,155,240,0.65)" : "none", opacity: isDragging2 ? 0.18 : 1, cursor: isDragging2 ? "grabbing" : isEditing ? "text" : "grab", touchAction: isEditing ? "auto" : "none", userSelect: "none", transition: "opacity 0.16s ease, background 0.16s ease, border-color 0.16s ease" },
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: `aver-enrolled-face-photo-${order}`, "aria-label": `Enrolled face ${index + 1}`, style: { width: "100%", height: 92, flex: "0 0 92px", boxSizing: "border-box", position: "relative", overflow: "hidden", borderBottom: `1px solid ${isEditing ? T.blue : T.line2}`, backgroundColor: "rgba(23,145,236,0.12)" }, children: [
                                  ...
                                  isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: `aver-enrolled-face-name-edit-state-${order}`, style: { flex: 1, minHeight: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "input",
                                    {
                ...
                faceEnrollmentTourOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-face-enrollment-tour-modal", role: "dialog", "aria-modal": "true", "aria-labelledby": "aver-face-enrollment-tour-title", style: { position: "fixed", inset: 0, zIndex: 75, padding: 16, background: "rgba(0,0,0,0.72)", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-face-enrollment-tour-dialog", style: { width: "min(780px, calc(100vw - 32px))", maxHeight: "calc(100vh - 32px)", overflow: "hidden", borderRadius: 10, border: `1px solid ${T.line2}`, background: "#101216", boxShadow: "0 22px 64px rgba(0,0,0,0.58)", display: "flex", flexDirection: "column" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-face-enrollment-tour-header", style: { minHeight: 48, padding: "0 14px 0 16px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: `1px solid ${T.line2}` }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 2, color: T.faint, fontSize: 11.5 }, children: "Use a clear, front-facing image with enough face detail." })
                    ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-face-enrollment-tour-content", style: { minHeight: 0, overflow: "hidden", padding: 14, display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: 10 }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-face-enrollment-tour-face-too-small", style: { minWidth: 0, padding: 10, borderRadius: 8, border: "1px solid rgba(239,83,80,0.30)", background: "rgba(239,83,80,0.05)" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 110, padding: 8, boxSizing: "border-box", borderRadius: 6, background: "#090b0f", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 150, height: 90, position: "relative", overflow: "hidden" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { role: "img", "aria-label": "Face is too small in the frame", viewBox: "430 -5 480 288", preserveAspectRatio: "xMidYMid slice", style: { width: "100%", height: "100%", display: "block" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("image", { href: FACE_ENROLLMENT_DEMO_IMAGE, x: "0", y: "0", width: FACE_ENROLLMENT_DEMO_SIZE.width, height: FACE_ENROLLMENT_DEMO_SIZE.height, preserveAspectRatio: "none" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "592", y: "105", width: "132", height: "145", fill: "none", stroke: "#ef5350", strokeWidth: "3", vectorEffect: "non-scaling-stroke" })
                      ] }) }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 8, color: "#ef6c68", fontSize: 12.5, fontWeight: 700 }, children: "Face too small" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 4, color: T.dim, fontSize: 11.5, lineHeight: 1.4 }, children: "Move closer or zoom in. The face must be large enough to capture clear facial detail." })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-face-enrollment-tour-face-blurred", style: { minWidth: 0, padding: 10, borderRadius: 8, border: "1px solid rgba(239,83,80,0.30)", background: "rgba(239,83,80,0.05)" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 110, padding: 8, boxSizing: "border-box", borderRadius: 6, background: "#090b0f", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { width: 90, height: 90, position: "relative", overflow: "hidden" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", inset: 0, filter: "blur(1.4px)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaceEnrollmentCrop, { candidateId: "blurred-distance", label: "Blurred moving face" }) }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 8, color: "#ef6c68", fontSize: 12.5, fontWeight: 700 }, children: "Face is blurred" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 4, color: T.dim, fontSize: 11.5, lineHeight: 1.4 }, children: "Keep the person and camera steady. Facial features must be sharp and clearly visible." })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-face-enrollment-tour-front-facing", style: { minWidth: 0, padding: 10, borderRadius: 8, border: "1px solid rgba(30,155,240,0.32)", background: "rgba(30,155,240,0.06)" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 110, padding: 8, boxSizing: "border-box", borderRadius: 6, background: "#090b0f", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { width: 90, height: 90, position: "relative", overflow: "hidden" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(FaceEnrollmentCrop, { candidateId: "front-center", label: "Front-facing person with both cheeks evenly visible" }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 8, color: T.blue, fontSize: 12.5, fontWeight: 700 }, children: "Face the camera" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 4, color: T.dim, fontSize: 11.5, lineHeight: 1.4 }, children: "Look straight at the camera and keep the left and right cheeks evenly visible." })
                    ] }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-face-enrollment-tour-priority-example", "aria-label": "Example of enrolled face cards ordered by priority", style: { width: "100%", minWidth: 0, boxSizing: "border-box", padding: 7, borderRadius: 6, border: `1px solid ${T.line}`, background: "#171a1f" }, children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", alignItems: "flex-start", gap: 7 }, children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { width: 76, height: 70, position: "relative", overflow: "hidden", border: `1px solid ${T.line2}`, boxSizing: "border-box", background: "rgba(23,145,236,0.12)" }, children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { position: "absolute", top: 3, left: 3, padding: "2px 4px", borderRadius: 3, border: "1px solid rgba(255,255,255,0.22)", background: "rgba(8,10,13,0.78)", color: "#fff", fontSize: 9, fontWeight: 700, lineHeight: 1 }, children: card.priority }),
                ...
                faceDeleteTarget && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-face-delete-modal", role: "dialog", "aria-modal": "true", "aria-labelledby": "aver-face-delete-title", style: { position: "fixed", inset: 0, zIndex: 60, padding: 24, background: "rgba(0,0,0,0.72)", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-face-delete-dialog", style: { width: "min(390px, calc(100vw - 48px))", overflow: "hidden", background: "#101216", border: `1px solid ${T.line2}`, borderRadius: 10, boxShadow: "0 20px 60px rgba(0,0,0,0.55)" }, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "flex-end", gap: 9, padding: "12px 16px", borderTop: `1px solid ${T.line2}`, background: "rgba(255,255,255,0.02)" }, children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-face-delete-confirm-button", type: "button", onClick: confirmFaceDelete, style: secondaryBtn, children: "OK" })
                  ] })
                ] }) })
              ] }) })
            ] })
    ...
    faceEnrollmentNoDataDialogOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        id: "aver-face-enrollment-no-data-modal",
        role: "presentation",
        onMouseDown: (event) => {
          if (event.target === event.currentTarget) setFaceEnrollmentNoDataDialogOpen(false);
        },
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-face-enrollment-no-data-dialog", role: "dialog", "aria-modal": "true", "aria-labelledby": "aver-face-enrollment-no-data-title", "aria-describedby": "aver-face-enrollment-no-data-message", style: { width: "min(390px, calc(100vw - 48px))", overflow: "hidden", background: "#101216", border: `1px solid ${T.line2}`, borderRadius: 10, boxShadow: "0 20px 60px rgba(0,0,0,0.58)" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-face-enrollment-no-data-title", style: { padding: "17px 18px 10px", color: T.text, fontSize: 16, fontWeight: 600 }, children: "Face Enrollment unavailable" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-face-enrollment-no-data-message", style: { padding: "0 18px 18px", color: T.dim, fontSize: 13, lineHeight: 1.55 }, children: "No data to enable Face Enrollment." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", justifyContent: "flex-end", padding: "12px 16px", borderTop: `1px solid ${T.line2}`, background: "rgba(255,255,255,0.02)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-face-enrollment-no-data-confirm-button", type: "button", autoFocus: true, onClick: () => setFaceEnrollmentNoDataDialogOpen(false), style: { height: 31, minWidth: 76, padding: "0 18px", borderRadius: 5, border: `1px solid ${T.line2}`, background: T.panel2, color: T.text, fontFamily: fUI, fontSize: 13, fontWeight: 500, cursor: "pointer" }, children: "OK" }) })
        ] })
      }
    ),
    faceLibraryFullDialogOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        id: "aver-face-library-full-modal",
        role: "presentation",
        onMouseDown: (event) => {
          if (event.target === event.currentTarget) setFaceLibraryFullDialogOpen(false);
        },
        style: { position: "fixed", inset: 0, zIndex: 110, padding: 24, background: "rgba(0,0,0,0.72)", display: "flex", alignItems: "center", justifyContent: "center" },
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-face-library-full-dialog", role: "dialog", "aria-modal": "true", "aria-labelledby": "aver-face-library-full-title", "aria-describedby": "aver-face-library-full-message", style: { width: "min(390px, calc(100vw - 48px))", overflow: "hidden", background: "#101216", border: `1px solid ${T.line2}`, borderRadius: 10, boxShadow: "0 20px 60px rgba(0,0,0,0.58)" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-face-library-full-title", style: { padding: "17px 18px 10px", color: T.text, fontSize: 16, fontWeight: 600 }, children: "Face library is full" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "aver-face-library-full-message", style: { padding: "0 18px 18px", color: T.dim, fontSize: 13, lineHeight: 1.55 }, children: "No more can be saved." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", justifyContent: "flex-end", padding: "12px 16px", borderTop: `1px solid ${T.line2}`, background: "rgba(255,255,255,0.02)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-face-library-full-confirm-button", type: "button", autoFocus: true, onClick: () => setFaceLibraryFullDialogOpen(false), style: { height: 31, minWidth: 76, padding: "0 18px", borderRadius: 5, border: `1px solid ${T.line2}`, background: T.panel2, color: T.text, fontFamily: fUI, fontSize: 13, fontWeight: 500, cursor: "pointer" }, children: "OK" }) })
        ] })
      }
    ),
