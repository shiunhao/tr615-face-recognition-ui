...
function App$1() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-paint-look-root", style: { position: "relative", background: T.page, width: "100%", height: "100vh", fontFamily: fUI, color: T.text, display: "flex", overflow: "hidden" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          versionMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-version-switcher-menu", role: "listbox", "aria-label": "Prototype versions", style: { position: "absolute", top: 0, right: "calc(100% + 6px)", width: 330, height: 34, boxSizing: "border-box", padding: 3, display: "flex", gap: 3, borderRadius: 6, border: `1px solid ${T.line2}`, background: T.panel2, boxShadow: "0 6px 20px rgba(0,0,0,0.42)", overflow: "hidden" }, children: [
            ...
            }, style: { flex: 1, minWidth: 0, height: 26, padding: "0 8px", border: "none", borderRadius: 4, background: "transparent", color: T.dim, fontFamily: fUI, fontSize: 11.5, textAlign: "center", cursor: "pointer" }, children: "V1 · 08/10" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-version-option-v2", type: "button", role: "option", "aria-selected": "false", onClick: () => window.location.assign(`${"./"}v2/index.html`), onMouseEnter: (event) => {
              ...
              event.currentTarget.style.background = "transparent";
            }, style: { flex: 1, minWidth: 0, height: 26, padding: "0 8px", border: "none", borderRadius: 4, background: "transparent", color: T.dim, fontFamily: fUI, fontSize: 11.5, textAlign: "center", cursor: "pointer" }, children: "V2 · 08/10" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "aver-version-option-v3", type: "button", role: "option", "aria-selected": "true", onClick: () => setVersionMenuOpen(false), style: { flex: 1, minWidth: 0, height: 26, padding: "0 8px", border: "none", borderRadius: 4, background: "rgba(30,155,240,0.16)", color: "#fff", fontFamily: fUI, fontSize: 11.5, fontWeight: 600, textAlign: "center", cursor: "pointer", boxShadow: `inset 0 -2px 0 ${T.blue}` }, children: "V3 · 08/11" })
          ] })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "aver-main-stage", style: { position: "relative", flex: 1, padding: versionMenuOpen ? "54px 24px 16px" : "16px 24px", minWidth: 0, background: T.page, overflow: "hidden", height: "100vh", display: "flex", flexDirection: "column", boxSizing: "border-box", transition: "padding 0.16s ease" }, children: [
